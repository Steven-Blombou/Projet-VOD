    ...
    <form class="form-contact" action="traitement/product_insert.php" method="post">
        ...
        <div class="info_form">
            <div class="infos">
              ...
              <input class="login" type="text" id="nom_product" name="nom_product" placeholder="Nom">

            <div class="infos">
                <label class="contact" for="Prenom">Prénom</label>
            </div>
              <input class="login" type="text" id="prenom_product" name="prenom_product" placeholder="Prénom">

              <div class="infos">
                  <label class="contact" for="Date">Date</label>
              </div>
               <input class="login" type="date" id="born_product" name="born_product" placeholder="Date">
