 ...
 <div align="center" id="Films" class="tabcontent">
  ...
  if(isset($_GET['erreur'])){  //je verifie si il ya des erreurs
      ...
      if($err==1 || $err==2 || $err==3)
          echo "<p style='color:red'>Le film n'a pas été suprimé</p>"; // si oui affichage du message d erreur en rouge
  }
  ?>
  ...
  if(isset($_GET['message'])){  //je verifie si il ya des erreurs
      $mess = $_GET['message'];
      if($mess==1)
          echo "<p style='color:green'>Le film a bien été suprimé</p>"; // si oui affichage du message d erreur en rouge
  }
  ?>
  <br>
